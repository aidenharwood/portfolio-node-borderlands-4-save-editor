...
export const completeAllChallenges: QuickUnlockAction = {
    id: 'complete-all-challenges',
    label: 'Complete All Challenges',
    icon: 'pi pi-lock',
    run(data: any) {
        ...
        const ACHIEVEMENTS = {
            ...(updatedData.stats.achievements || {}),
        ...
        const MISC = {
            ...(updatedData.stats.openworld?.misc || {}),
            fish: 50
        }

        updatedData.stats = updatedData.stats || {}
        updatedData.stats.challenge = CHALLENGE
        updatedData.stats.openworld = updatedData.stats.openworld || {}
        updatedData.stats.openworld.misc = MISC
        updatedData.stats.achievements = ACHIEVEMENTS
