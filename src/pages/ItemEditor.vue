      ...
      <div class="space-y-6">
        ...
        <div class="rounded-lg border border-border/60 bg-card/60 p-4">
          ...
          <div class="flex gap-2">
            ...
            <button 
              @click="pasteSample"
              class="px-4 py-2 rounded-md border border-border/60 bg-background hover:bg-muted/50 text-sm transition">
              Sample
            </button>
          </div>
        ...
        <div v-if="decoded" class="space-y-4">
          ...
          <div class="rounded-lg border border-border/60 bg-card/60 p-4">
            ...
            <div class="space-y-4">
              <div>
                <div class="flex items-center justify-between mb-2">
                  ...
                  <div class="flex gap-2">
                    <button 
                      @click="newLevel = 1"
                      class="px-3 py-1 text-xs rounded-md border border-border/60 bg-background hover:bg-muted/50 transition">
                      Min (1)
                    </button>
                    <button 
                      @click="newLevel = 50"
              ...
              <button 
                ...
                class="w-full px-4 py-2 rounded-md bg-accent text-accent-foreground font-medium hover:bg-accent/90 disabled:opacity-50 disabled:cursor-not-allowed transition">
                Apply Level Change
              </button>
            </div>
          </div>
            ...
            <div class="space-y-4">
              ...
              <div class="flex gap-2">
                ...
                <button 
                  ...
                  class="flex-1 px-4 py-2 rounded-md bg-accent text-accent-foreground font-medium hover:bg-accent/90 disabled:opacity-50 disabled:cursor-not-allowed transition">
                  Apply Seed Change
                </button>
              </div>
            </div>
          ...
          <div v-if="modifiedSerial" class="rounded-lg border-2 border-accent/60 bg-accent/5 p-4">
            ...
            <div class="flex gap-2">
              ...
              <button 
                ...
                class="px-4 py-2 rounded-md bg-accent text-accent-foreground hover:bg-accent/90 transition">
...
import { decodeSerial, type DecodedSerial } from '../lib/nicnl-decoder'
import { modifyLevel, modifyRandomSeed } from '../lib/nicnl-encoder'
